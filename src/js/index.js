...
(function e(t, n, r) {
    ...
    */
      ...
      */
		...
		}).call(this, require("rH1JPG"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/../../node_modules/slick-carousel/slick/slick.js", "/../../node_modules/slick-carousel/slick");
	}, { "buffer": 2, "jquery": 4, "rH1JPG": 5 }], 7: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			...
			module.exports = function () {
				...
				var _parser$parseLinkRefe = parser.parseLinkReference(),
				    album = _parser$parseLinkRefe.album,
				    id = _parser$parseLinkRefe.id;
				...
				var currentAlbumN = album && album.idAlbum || 0;
				...
				var showCurrentAlbum = function showCurrentAlbum() {
					...
					var albumNode = document.querySelector(".music-player-albums--item[data-album=\"" + currentAlbumN + "\"]");
				...
				playButton.onclick = function () {
					if (player.element.paused) {
						...
						removeActive();
						var item = document.querySelector(".music-player-content--item[data-index=\"" + 0 + "\"]");
						if (item) {
				...
				var playNext = function playNext() {
					removeActive();
					player.playNext();
					var item = document.querySelector(".music-player-content--item[data-index=\"" + player.song + "\"]");
					if (item) {
						item.classList.add('active');
						return;
					}
				...
				setCurrentSong = function setCurrentSong() {
					...
					player.setTrack(id);
					var element = document.querySelector(".music-player-content--item[data-index=\"" + player.song + "\"]");
					if (!element) {
						return;
					}
	...
	}, { "./music": 11, "./parser": 12, "./player": 13, "./scroller": 14, "buffer": 2, "rH1JPG": 5 }], 8: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			var handleAudio = require('./audio');
			var handleFloatingMenu = require('./follow');
			var handleMetrics = require('./metrics');
			var handleSlider = require('./slider');
			var initializeSnow = require('./topper');
		...
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			...
			var handleFloatingMenu = function handleFloatingMenu(wrapper, header) {
			...
			module.exports = function () {
				...
				window.addEventListener('scroll', function () {
					return handleFloatingMenu(follow, header);
				});
	...
	}, { "buffer": 2, "rH1JPG": 5 }], 10: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			var onLinkClicked = function onLinkClicked(e) {
			...
			module.exports = function () {
				var buttons = document.querySelectorAll('a[data-link]');
				buttons.forEach(function (btn) {
					return btn.addEventListener('click', onLinkClicked);
				});
			};
	...
	}, { "./music": 11, "buffer": 2, "rH1JPG": 5 }], 13: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			var parser = require('./parser');
	...
	}, { "./parser": 12, "buffer": 2, "rH1JPG": 5 }], 14: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
	...
	}, { "buffer": 2, "rH1JPG": 5 }], 15: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			var $ = require('jquery');
	...
	}, { "buffer": 2, "jquery": 4, "rH1JPG": 5, "slick-carousel": 6 }], 16: [function (require, module, exports) {
		(function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
			var initializeSnow = function initializeSnow() {
